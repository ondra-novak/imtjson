...
void runJwtTests(TestSimple &tst) {
	...
	tst.test("jwt.check.ES512","{\"aaa\":123,\"bbb\":323}") >> [](std::ostream &out) {
		std::string token = "eyJhbGciOiJFUzUxMiJ9.eyJhYWEiOjEyMywiYmJiIjozMjN9.MIGHAkFld_cQbTJZdJncEZMdVDDegaqYnwDMVfOCMfoez8hRA4zhcIa47ojgSFYSupfCLb1TP1slngJOdJHkGWEP4poQFAJCATWAa9PbHCR4JGA5Pf2l4MRcTzL4cLs4-_E8SCq6PFB9Lnoeip3g1sqPmyuYIMr5jHDoIDFb60O5Ntfn3m7Zqcxw";
